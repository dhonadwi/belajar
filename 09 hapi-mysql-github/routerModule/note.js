const getAllKaryawan = require('./getAllKaryawan');
const routerModule = (hapiServer, connection) => {
    hapiServer.route([
        {
            // router get note (all)
            method: 'GET',
            path: '/note',
            handler: getAllKaryawan,
        },
        {
            ...
            handler: function (req, res) {
                ...
                var query = `SELECT * FROM dta_karyawan WHERE id_karyawan ='${id}' `;
